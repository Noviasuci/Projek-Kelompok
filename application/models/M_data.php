...
class M_data extends CI_Model
{
	...
	public function insert_multiple()
	{
		...
		$this->db->insert_batch('tb_jadwal', $entri);
		return true;
	}
	...
	public function insert_jawaban($jawaban, $entri)
	{
	...
	public function UpdateNilai2($id_jadwal, $data)
	{
		$this->db->where('id_jadwal', $id_jadwal);
		$this->db->update('tb_jadwal', $data);
	}

	public function get_jadwal($id_siswa)
	{
		$this->db->select('*');

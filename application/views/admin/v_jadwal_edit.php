    ...
    <?php foreach ($jadwal as $p) { ?>
      <div class="col-md-12">
        <div class="box box-success">
          ...
          <!-- /.box-header -->
          <!-- form start -->
          <form class="form-horizontal" action="<?= base_url('jadwal/update'); ?>" method="post">
            <div class="box-body">
              <div class="form-group">
                <label class="col-sm-2 control-label">Nama peserta</label>
                <input type="hidden" name="id" value="<?= $p->id_jadwal ?>">
                <div class="col-sm-10">
                  <select class="select2 form-control" name="jadwal" required>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  <button type="submit" class="btn btn-primary btn-flat" title="Update jadwal"><span class="fa fa-save"></span> Simpan</button>
                </div>
              </div>
            </div>
            <!-- /.box-body -->

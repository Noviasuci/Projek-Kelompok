    ...
    <div class="row">
      ...
      <div class="box box-success" style="overflow-x: scroll;">
        <div class="box-header">
          <center><h4 class="box-title">Daftar Jadwal Ujian</h4></center><p>
          <h3 class="box-title"></h3>
          <a href="<?php echo base_url('jadwal_tambah'); ?>"><button type="button" class="btn btn-primary btn-flat" data-toggle="modal" data-target="#jadwal_tambah" ><span class="fa fa-plus"></span> Tambah </button></a>
                                        ...
                                        == null) { ?>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    <li><a href="<?= base_url() . 'jadwal/edit/' . $d->id_jadwal; ?>">Edit Data</a></li>
                                                    <li><a href="<?= base_url() . 'jadwal/hapus/' . $d->id_jadwal; ?>" onclick="return confirm('Apakah yakin data peserta ini di hapus?')">Hapus Data</a></li>
                                                </ul>
                                            </div>
                                        <?php } else {
                                            echo '-';

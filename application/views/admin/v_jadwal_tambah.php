    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="box box-success" style="overflow-x: scroll;">
              ...
              <center><h3 class="box-title">Tambah Jadwal Ujian</h3></center>               
       </div>
                <!-- /.box-header -->
                <!-- form start -->
        ...
        <div class="col-md-12">
            <div class="box box-success" style="overflow-x: scroll;">
                <form class="form-horizontal" action="<?=base_url('jadwal_tambah/insert_');?>" method="post">
                   <div class="box-body">
                    <div class="form-group">
                  ...
                  <div class="box-footer">
                     <a href="<?=base_url('jadwal')?>" class="btn btn-default btn-flat"><span class="fa fa-arrow-left"></span> Kembali</a>
